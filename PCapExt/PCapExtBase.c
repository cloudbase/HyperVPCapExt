...
PWCHAR SxExtFriendlyName = L"Hyper-V packet capture extension";
PWCHAR SxExtUniqueName = L"{9D283D4B-2343-42E2-98C8-2D0511169E8D}";
PWCHAR SxExtServiceName = L"PCapExt";
ULONG SxExtAllocationTag = 'paCP';
ULONG SxExtOidRequestId = 'paCP';
    ...
    )
{
    ...
    DecodeNetBufferListAndQueueForPCap(NetBufferLists);
